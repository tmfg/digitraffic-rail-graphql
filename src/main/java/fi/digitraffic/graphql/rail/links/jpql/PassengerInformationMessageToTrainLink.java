...
@Component
public class PassengerInformationMessageToTrainLink extends OneToOneLinkJpql<TrainId, PassengerInformationMessageTO, Train, TrainTO> {
    ...
    protected KeyWhereClause buildKeyWhereClause(final List<TrainId> keys) {
        ...
        return TrainIdJpqlWhereClause.build(getEntityAlias(), "id.departureDate", "id.trainNumber", nonNullKeys);
    }
}
