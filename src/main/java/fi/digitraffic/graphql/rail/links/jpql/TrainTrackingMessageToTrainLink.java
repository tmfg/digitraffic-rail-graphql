...
@Component
public class TrainTrackingMessageToTrainLink extends OneToOneLinkJpql<TrainId, TrainTrackingMessageTO, Train, TrainTO> {
    ...
    protected KeyWhereClause buildKeyWhereClause(final List<TrainId> keys) {
        return TrainIdJpqlWhereClause.build(getEntityAlias(), "id.departureDate", "id.trainNumber", keys);
    }
}
