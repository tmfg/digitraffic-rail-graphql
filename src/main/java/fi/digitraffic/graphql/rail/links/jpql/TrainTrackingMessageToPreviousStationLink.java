...
@Component
public class TrainTrackingMessageToPreviousStationLink extends OneToOneLinkJpql<String, TrainTrackingMessageTO, Station, StationTO> {
    ...
    public String createKeyFromParent(final TrainTrackingMessageTO msg) {
        return Strings.nullToEmpty(msg.getPreviousStationShortCode());
    }
