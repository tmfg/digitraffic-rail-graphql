...
@Component
public class TrainTrackingMessageToStationLink extends OneToOneLinkJpql<String, TrainTrackingMessageTO, Station, StationTO> {

    private final StationTOConverter stationTOConverter;

    public TrainTrackingMessageToStationLink(final JpqlWhereBuilder jpqlWhereBuilder,
    ...
    public String createKeyFromParent(final TrainTrackingMessageTO msg) {
        return msg.getStationShortCode();
    }
