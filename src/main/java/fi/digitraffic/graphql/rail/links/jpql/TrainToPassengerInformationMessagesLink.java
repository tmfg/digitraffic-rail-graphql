...
import fi.digitraffic.graphql.rail.queries.jpql.PassengerInformationMessagesQuery;
...
public class TrainToPassengerInformationMessagesLink
        extends OneToManyLinkJpql<TrainId, TrainTO, PassengerInformationMessage, PassengerInformationMessageTO> {
    ...
    protected KeyWhereClause buildKeyWhereClause(final List<TrainId> keys) {
        return TrainIdJpqlWhereClause.build(getEntityAlias(), "trainDepartureDate", "trainNumber", keys);
    }
