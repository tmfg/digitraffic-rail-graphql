...
@Component
public class CompositionToJourneySectionsLink extends OneToManyLinkJpql<TrainId, CompositionTO, JourneySection, JourneySectionTO> {
    ...
    protected KeyWhereClause buildKeyWhereClause(final List<TrainId> keys) {
        return TrainIdJpqlWhereClause.build(getEntityAlias(), "trainId.departureDate", "trainId.trainNumber", keys);
    }
}
