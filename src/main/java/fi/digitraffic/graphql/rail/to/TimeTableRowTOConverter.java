...
public class TimeTableRowTOConverter extends BaseConverter<TimeTableRowTO> {
    ...
    public TimeTableRowTO convert(Tuple tuple) {
        return new TimeTableRowTO(
                ...
                tuple.get(QTimeTableRow.timeTableRow.differenceInMinutes),
                ...
                tuple.get(QTimeTableRow.timeTableRow.id.attapId),
                tuple.get(QTimeTableRow.timeTableRow.id.trainNumber),
