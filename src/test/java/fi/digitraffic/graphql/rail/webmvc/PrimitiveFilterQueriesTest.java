...
public class PrimitiveFilterQueriesTest extends BaseWebMVCTest {
    ...
    public void enumFilterShouldWork() throws Exception {
        final Train train66 = trainFactory.createBaseTrain(new TrainId(66L, LocalDate.of(2020, 9, 17))).getFirst();
        final Train train67 = trainFactory.createBaseTrain(new TrainId(67L, LocalDate.of(2020, 9, 17))).getFirst();
        final Train train68 = trainFactory.createBaseTrain(new TrainId(68L, LocalDate.of(2020, 9, 17))).getFirst();
        final Train train69 = trainFactory.createBaseTrain(new TrainId(69L, LocalDate.of(2020, 9, 17))).getFirst();
